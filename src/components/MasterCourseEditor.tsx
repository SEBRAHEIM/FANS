                ...
                {module.module_type === 'slides' && (
                    <>
                        ...
                        <div className="flex-1 flex flex-col p-8 overflow-hidden">
                            <div className="flex-1 flex items-center justify-center bg-slate-100 rounded-[2.5rem] shadow-inner relative group/main">
                                {/* Toolbar Overlay */}
                                ...
                                <div
                                    ref={canvasRef}
                                    className="aspect-video w-[85%] bg-white rounded-2xl shadow-2xl relative overflow-hidden"
                                    style={{
