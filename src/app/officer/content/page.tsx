            ...
            <main className="flex-1 p-6 xl:p-12 pt-24 xl:pt-10">
                ...
                <div className="grid grid-cols-1 gap-6">
                    <div className="bg-zinc-900 border border-zinc-800 p-12 rounded-[2.5rem] flex flex-col items-center justify-center text-center">
                        ...
                        <h3 className="text-2xl font-bold text-white mb-2">Content Manager</h3>
                        <p className="text-zinc-500 max-w-md">Course materials and exam synchronization is in progress. Site editors can upload local files directly to the server.</p>
                    </div>
                </div>
            </main>
        </div>
